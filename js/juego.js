...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png', 170, 270, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 550, 120, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 800, 350, 30, 30, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 300, 450, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 400, 200, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 500, 80, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 120, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 90, 300, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 500, 300, 15, 30, 2)
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 200, 400, 10, 10, 1, {desdeX: 200, hastaX: 250, desdeY: 400, hastaY: 410}),
    new ZombieCaminante('imagenes/zombie2.png', 400, 400, 10, 10, 1, {desdeX: 400, hastaX: 430, desdeY: 400, hastaY: 450}),
    new ZombieCaminante('imagenes/zombie3.png', 700, 70, 10, 10, 1, {desdeX: 700, hastaX: 750, desdeY: 80, hastaY: 110}),
    new ZombieCaminante('imagenes/zombie4.png', 750, 200, 10, 10, 1, {desdeX: 750, hastaX: 890, desdeY: 200, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie1.png', 280, 200, 10, 10, 1, {desdeX: 280, hastaX: 300, desdeY: 200, hastaY: 240}),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 3, {desdeX: 644, hastaX: 644, desdeY: 0, hastaY: 487}, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 487, 30, 90, 3, {desdeX: 678, hastaX: 678, desdeY: 0, hastaY: 487}, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 3, {desdeX: 0, hastaX: 871, desdeY: 322, hastaY: 322}, 'h')
  ]
